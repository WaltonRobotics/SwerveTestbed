...
public class Drivetrain extends SubsystemBase {
    ...
    private static WaltonSwerveModule[] swerveModules = new WaltonSwerveModule[4];
    ...
    public Drivetrain() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            WPI_TalonFX driveTalon = new WPI_TalonFX(i + 11);
...
//    }
   ...
   // i is [0, 3]
    public static SwerveModulePosition getPosition(WaltonSwerveModule swerveMod){
        return new SwerveModulePosition(
            falconToMeters(swerveMod.getAzimuthAbsoluteEncoderCounts(), kWheelCircumference, kDriveGearRatio), 
            getAngle(swerveMod));
    }

    private static Rotation2d getAngle(WaltonSwerveModule swerveMod){
        return Rotation2d.fromDegrees(falconToDegrees(swerveMod.getAzimuthAbsoluteEncoderCounts(), kDriveGearRatio));
    }
